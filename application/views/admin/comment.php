    ...
    <table class="table fileslist">
     ...
     ?>
        <tr>
          ...
          <td><?php echo $line['username']?>[<?php echo $line['uid'] ? '<a href="?username='.$line['username'].'">'.$line['username'].'</a>' : '未注册';?>]<br /><a href="<?php echo $line['userurl']?>" target="_blank"><?php echo $line['userurl']?></a> <?php echo $line['ip']?></td>
